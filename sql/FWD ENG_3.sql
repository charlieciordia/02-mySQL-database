...
CREATE TABLE IF NOT EXISTS `film_rental`.`rental` (
  ...
  `rental_date_day` DATETIME NULL DEFAULT NULL,
  `rental_date_hour` DATETIME NULL DEFAULT NULL,
  `return_date_day` DATETIME NULL DEFAULT NULL,
  `return_date_hour` DATETIME NULL DEFAULT NULL,
